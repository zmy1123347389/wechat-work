...
public class Page {
	...
	public String getPageStr() {
		...
		if (totalResult > 0) {
			...
			if (pageIndex == 1) {
				...
				sb.append("	<li><a href=\"#@\" onclick=\"nextPage(" + (pageIndex - 1) + ")\">上页</a></li>\n");
			}
			...
			if (pageIndex == totalPage) {
				...
				sb.append("	<li><a href=\"#@\" onclick=\"nextPage(" + (pageIndex + 1) + ")\">下页</a></li>\n");
				sb.append("	<li><a href=\"#@\" onclick=\"nextPage(" + totalPage + ")\">尾页</a></li>\n");
			}
			sb.append("	<li class=\"pageinfo\">第" + pageIndex + "页</li>\n");
	...
	public String toJsonString(Page page) {
		JSONObject jsonObject = new JSONObject();
		try {
			jsonObject.put("pageSize", page.getPageSize());
			jsonObject.put("totalPage", page.getTotalPage());
			jsonObject.put("totalResult", page.getTotalResult());
			jsonObject.put("pageIndex ", page.getPageIndex());
			jsonObject.put("currentResult", page.getCurrentResult());
